...
if selected_pred=='Diabetes':
    ...
    image = Image.open("C:/Users/rajal/Desktop/Streamlit/dia.png")
...
if selected_pred=='Chronic Kidney Disease':
    ...
    image = Image.open(r"C:\Users\rajal\Desktop\Streamlit\kid.png")
    st.image(image, use_column_width= True)
...
if selected_pred=='Heart Disease':
    ...
    restecg= st.text_input('Resting electrocardiographic results( Enter 0,1 or 2)')
    thalach = st.text_input('Maximum heart rate achieved')
    exang= st.text_input('Exercise induced angina')
    oldpeak = st.text_input('ST depression induced by exercise relative to rest')
    slope = st.text_input('Slope of the peak exercise ST segment')
    ca = st.text_input('Number of major vessels (0-3) colored by flourosopy')
    thal = st.text_input('Thalassemia (Enter 0, 1 or 2 where 0 = normal; 1 = fixed defect; 2 = reversable defect)')
